...
if (isset($_POST['ChangeProfile'])) {
    ...
    if ($postStmt) {
        $success = "Tài khoản đã cập nhật" && header("refresh:1; url=dashboard.php");
    } else {
...
if (isset($_POST['checker'])) {
    ...
    if (isset($_POST['confirm_password']) && !empty($_POST['confirm_password'])) {
        ...
        $error = 1;
        $err = "Mật khẩu nhập lại không được bỏ trống!";
    }
    ...
    if ($error!=1) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['staff_password']) {
                ...
                //declare a varible which will be passed to alert function
                if ($stmt) {
                    $success = "Mật khẩu đã thay đổi!" && header("refresh:1; url=dashboard.php");
                } else {
                    $err = "Vui lòng thử lại sau";
                }
            }
            ...
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../admin/assets/img/theme/restro00.jpg); background-size: cover; background-position: center top;">
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        ...
                        <h1 class="display-2 text-white">Chào mừng<?php echo $staff->staff_name; ?></h1>
              <p class="text-white mt-0 mb-5"> Đây là trang hồ sơ cá nhân. Bạn có thể thay đổi hồ sơ hoặc thay đổi mật khẩu.</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-email">Xác nhận mật khẩu</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="checker" class="btn btn-success form-control-alternative" value="Đổi mật khẩu">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
