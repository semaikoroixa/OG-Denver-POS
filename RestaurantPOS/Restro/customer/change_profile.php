...
if (isset($_POST['ChangeProfile'])) {
  ...
  if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email'])) {
    ...
    if ($postStmt) {
      $success = "Hồ sơ đã cập nhật" && header("refresh:1; url=dashboard.php");
    } else {
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            <h1 class="display-2 text-white">Welcome <?php echo $customer->customer_name; ?></h1>
                            <p class="text-white mt-0 mb-5">Xin chào, đây là trang hồ sơ của bạn</p>
                        </div>
                    </div>
                </div>
            </div>
