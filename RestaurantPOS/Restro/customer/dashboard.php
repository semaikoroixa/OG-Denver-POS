              ...
              <a href="orders.php">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Danh sách món ăn</h5>
              ...
              <a href="orders_reports.php">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Tổng đơn đã đặt</h5>
              ...
              <a href="payments_reports.php">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Tổng tiền đã thanh toán</h5>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php if ($order->order_status == '') {
                            echo "<span class='badge badge-danger'>Chưa trả</span>";
                          } else {
        ...
        <div class="col-xl-12">
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Thanh toán gần đây của tôi</h3>
                </div>
                <div class="col text-right">
